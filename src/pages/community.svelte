<Page>
    <Navbar title={f7route.params["name"]} backLink="Back" />
  ...
  <Messages>
    <MessagesTitle><b>{day}, {month} {date},</b> {time}</MessagesTitle>
  ...
  let time = today.toLocaleString("en-US", { hour: "2-digit", minute: "2-digit" })
